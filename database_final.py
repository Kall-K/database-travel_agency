...
path1 = 'D:/Desktop/5o eksamino/baseis_dedomenon/BaseisDedomenon2022-23-main/'
...
for i in range(43): #new
    reg = []
    wrk_AT = "AM" + str((random.randint(1,9)*pow(10,6)) + (random.randint(1,9)*pow(10,5)) + (random.randint(1,9)*pow(10,4)) + (random.randint(1,9)*pow(10,3)) + (random.randint(1,9)*pow(10,2)) + (random.randint(1,9)*pow(10,1)) + (random.randint(1,9)*pow(10,0)) )
...
for i in range(20):
    ...
    e_date.append(f"2015-12-{i%10+13}")
...
with open(path1 + '3.automation.txt', 'w', encoding='utf-8') as the_file:
    the_file.write(final_text + '\n')
